...
<script type="text/javascript">
	function changeImage() {
		...
		document.getElementById("img").src = "${pageContext.request.contextPath}/captchaCode?time="
				+ new Date().getTime();
	}
</script>
</head>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<td colspan="2" style="width:50%"><img
									src="${pageContext.request.contextPath}/captchaCode" width="180"
									height="30" class="textinput" style="height:30px;" id="img" />&nbsp;&nbsp;
									<a href="javascript:changeImage()">看不清换一张</a>
								</td>
							</tr>
						</table>
